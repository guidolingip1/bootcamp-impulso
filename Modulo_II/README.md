...
Antigamente se utilizava apenas div para gerenciar os espaços em HTML

Hoje em dia exitste uma semântica para isso

- Aside: Algo que está na lateral da página

- footer: rodapé, pode ser da página, pode ser de um aqrticle
...
| Tag   | significado                    |
| ----- | ------------------------------ |
| h1-h6 | Diferentes tamanhos de headers |
| p     | Parágrafo                      |
| a     | anchor                         |
